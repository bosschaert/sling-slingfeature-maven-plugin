...
class JarDecompressor {
    ...
    static void decompress(File in, File out) throws IOException {
        try (JarInputStream jis = new JarInputStream(new FileInputStream(in));
            ...
            while ((je = jis.getNextJarEntry()) != null) {
                ...
                try (FileOutputStream fos = new FileOutputStream(tmpFile)) {
                    ...
                    jos.putNextEntry(ze);
                    // TODO check for directories? Do we need them at all?
    ...
    static void drainStream(InputStream is, OutputStream os, byte[] buf) throws IOException {
        int sz = 0;
